...
$(".list-group").on("click", "span", function () {
  ...
  dateInput.datepicker({
    minDate: 1,
    onClose: function () {
      //when the calender is closed w/o editing the change function will execute on dateInput to change back to span element
      $(this).trigger("change");
    }
  });
...
$(".list-group").on("change", "input[type='text']", function () {
  ...
  auditTask($(taskSpan).closest(".list-group-item")); //removes colored backgrounds when due date changes from if statement
...
//adding color to past due task or upcoming due tasks
var auditTask = function (taskEl) {
  ...
  //apply new class if task are over or near due date
